...
export default function Hero() {
  return (
    <section
      id="about"
      className="flex flex-col md:flex-row justify-between lg:h-screen bg-[#222831] text-[#00ADB5] px-8 md:px-16 xl:px-64 py-8 lg:py-0"
    >
      <div className="flex flex-col justify-center items-start w-full">
        <div>
          <h1 className="text-5xl lg:text-6xl font font-bold">John Irson O.</h1>
          <h1 className="text-2xl pb-1">Software Developer | Web Developer</h1>
